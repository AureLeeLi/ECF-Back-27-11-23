...
@section('content')
    ...
    <div class="flex">
        <form action="" method="post" class="w-50" enctype="multipart/form-data">
            ...
            <input placeholder="media.jpg, .jpeg, .png, .gif" type="file" name="cover" value="{{ old('cover', $item->cover) }}" class="my-2 py-2 px-2 border-2 rounded-lg border-[bg-slate-50] w-full">
